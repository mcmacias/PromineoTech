 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
console.log(alphabetArray.toReversed());
//console.log(alphabetBackwards);

//console.log(alphabetArray.toString()); this keeps the commas in the string
console.log(alphabetArray.join(''));  //this will to, adding '' helps get rid of that 
//console.log(alphabetArray.toString()); //even with '' still keeps commas
...
console.log(array1);
//console.log(array1.splice(2,1)); // splice cuts it out, which we just want to print
console.log(array1.at(2));
console.log(array1.toReversed().at(0));
array1.push(16, 3);
//array1.push(3);
console.log(array1);
console.log(array1.at(2));
...
//console.log(reverse(undeclaredVariable));
